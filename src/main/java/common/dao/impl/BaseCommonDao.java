...
import common.dao.IBaseCommonDao;
...
public abstract class BaseCommonDao<T, PK extends Serializable> implements IBaseCommonDao {
	/**
	 * 初始化Log4j的一个实例
	 */
	private static final Logger logger = Logger.getLogger(BaseCommonDao.class);
	/**
